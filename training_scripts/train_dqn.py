"""
Training script for DQN (Deep Q-Network) on AgroTrack environment
"""
...
def train_dqn(total_timesteps=100000, save_path='../models/dqn_agrotrack'):
    """
    Train DQN agent on AgroTrack environment.
    ...
    """
    print("=" * 50)
    print("Training DQN on AgroTrack Environment")
    print("=" * 50)
    ...
    # Save final model
    final_model_path = f"{save_path}/dqn_final"
