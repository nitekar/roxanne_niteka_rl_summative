"""
Training script for A2C (Advantage Actor-Critic) on AgroTrack environment
"""
...
def train_a2c(total_timesteps=100000, save_path='../models/a2c_agrotrack'):
    """
    Train A2C agent on AgroTrack environment.
    ...
    """
    print("=" * 50)
    print("Training A2C on AgroTrack Environment")
    print("=" * 50)
    ...
    # Save final model
    final_model_path = f"{save_path}/a2c_final"
...
if __name__ == "__main__":
    ...
    # Train A2C
    model = train_a2c(total_timesteps=100000)
